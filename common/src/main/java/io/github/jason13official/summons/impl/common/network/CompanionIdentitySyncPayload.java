...
/// Server -> tracking clients: rarest-changing fields (type set once at spawn, form/wisp
/// only on evolution/death). Split out so these almost-static fields aren't resent on
/// every crystal pickup or ability use.
