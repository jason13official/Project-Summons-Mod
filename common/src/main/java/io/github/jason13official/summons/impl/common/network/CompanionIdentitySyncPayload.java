...
public record CompanionIdentitySyncPayload(int entityId, byte companionType, String evolutionForm,
                                           String reachedForms, boolean wisp, int generation) implements CustomPacketPayload {
  ...
  private static CompanionIdentitySyncPayload read(FriendlyByteBuf buf) {
    ...
    return new CompanionIdentitySyncPayload(entityId, companionType, evolutionForm, reachedForms, wisp, generation);
  }
