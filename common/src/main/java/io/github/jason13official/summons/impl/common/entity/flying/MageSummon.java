...
public class MageSummon extends AbstractFlyingCompanion {
  ...
  private static final double LIGHTNING_STRIKE_RADIUS = 12.0;
  ...
  private static final List<CompanionAbility> ABILITIES = List.of(
      new CompanionAbility("Lightning Strike", 30, (companion, owner) -> {
        ...
        AABB area = companion.getBoundingBox().inflate(LIGHTNING_STRIKE_RADIUS);
        LivingEntity target = companion.level().getEntitiesOfClass(LivingEntity.class, area,
