...
/// A Command-mode ability; `requiredForms` empty means base kit, always available. `description` is flavor text for the Companion screen, straight from the wiki. See
