...
/// A single "B"-spell bit (Mage's Floating B/Satellite B/etc): orbits the owner's position, damaging living entities it passes through. Simulated per-tick (position + hit-testing), not a real
/// registered Entity -> avoids new registry/renderer infra for a short-lived VFX.
